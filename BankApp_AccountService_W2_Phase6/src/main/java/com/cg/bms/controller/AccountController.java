...
public class AccountController {
	...
	public Account getAccount1() {
		Account account = aaccountRepository.getAccount(1000000000L);
		
		account.setAccountType(environment.getProperty("local.server.port"));
	...
	public AccountDto deposit(@PathVariable Long accountNumber, @RequestBody DepositRequest depositRequest)
	...
	public AccountDto withdraw(@PathVariable Long accountNumber, @RequestBody WithdrawRequest withdrawRequest)
			throws AccountException {
	...
	public AccountDto transfer(@PathVariable Long fromAccountNumber, @RequestBody TransferRequest transferRequest)
			throws AccountException {
		return accountMgmService.transfer(fromAccountNumber, transferRequest.getTargetAccount(),
	...
	public AccountDto addAccount(@RequestBody AccountDto accountDto) throws AccountException {
		return accountMgmService.addAccount(accountDto.getAccountType(), accountDto.getBalance(),
